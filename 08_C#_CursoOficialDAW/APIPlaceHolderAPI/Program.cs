...
using static APIPlaceHolderAPI.APILoadJson;
...
namespace APIPlaceHolderAPI
{
    internal class Program
    {
        ...
        public static string Url => "https://jsonplaceholder.typicode.com/todos/"; // *cambiar url*

        public static List<FavoriteItemList> favoriteList = new List<FavoriteItemList>();

        public static string NameProperty => "Tarea";
        public static string NameApi => "PlaceHolderAPI";
        ...
        {
            Console.Write("Introduce el Id de la tarea: ");
            int id = ValidateInput(Console.ReadLine());

            Console.WriteLine("Buscando...");
            var result = await SearchByUserId(id);
            ...
            $"Id: {(item["id"] == null ? "Unknown" : item["id"])}\n" +
            $"Titulo: {item["title"]}\n" +
