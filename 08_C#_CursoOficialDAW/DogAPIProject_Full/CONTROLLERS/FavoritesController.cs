...
namespace APIDogAPI.CONTROLLERS
{
    internal static class FavoritesController
    {
        ...
        {
            Views.Views.PrintFavoritesList(_favorites);
        ...
        public static void RemoveFavorite()
        {
            ...
            {
                Views.Views.PrintNotFoundFavorite();
                Views.Views.PrintWaitForPressKey();
                return;
            }
            ...
            string input = Helpers.Helpers.ReadInput();

            int index = Helpers.Helpers.ValidateIndexSelection(input, _favorites.Count);
            if (index == -1)
            {
            ...
            Views.Views.PrintAskRemoveFavorite();
            if (!Helpers.Helpers.Confirm(Helpers.Helpers.ReadInputUpper()))
            {
                Views.Views.PrintCancelOperation();
                Views.Views.PrintWaitForPressKey();
                return;
            }
            ...
            SaveFavoritesToJson();
            Views.Views.PrintSuccessOperation();
            Views.Views.PrintWaitForPressKey();
        }
        ...
        public static void ClearFavorites()
        {
            ...
            Views.Views.PrintAskClearFavorites();
            if (!Helpers.Helpers.Confirm(Helpers.Helpers.ReadInputUpper()))
            {
                Views.Views.PrintCancelOperation();
                Views.Views.PrintWaitForPressKey();
        ...
        public static async Task AddFavoriteFromRandomImage()
        {
            ...
            Views.Views.PrintImageUrl(imageUrl);

            Views.Views.PrintAskAddFavorite();
            if (!Helpers.Helpers.Confirm(Helpers.Helpers.ReadInputUpper()))
            {
                Views.Views.PrintCancelOperation();
                Views.Views.PrintWaitForPressKey();
