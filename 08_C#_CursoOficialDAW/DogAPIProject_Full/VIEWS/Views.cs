...
namespace APIDogAPI.VIEWS
{
    internal static class Views
    {
        ...
        public static void ShowMenu()
        {
            ...
            Console.WriteLine("====================================");
            Console.WriteLine("1. Mostrar todas las razas de perros           (DogApiController.ShowAllBreeds)");
            Console.WriteLine("2. Mostrar subrazas de una raza                (DogApiController.ShowSubBreeds)");
            Console.WriteLine("3. Mostrar imágenes aleatorias de una raza     (DogApiController.ShowRandomImagesByBreed)");
            Console.WriteLine("4. Buscar raza por nombre aproximado           (SearchController.SearchBreedByApproximateName)");
            Console.WriteLine("5. Agregar imagen aleatoria de una raza a favoritos (FavoritesController.AddFavoriteFromRandomImage)");
            Console.WriteLine("6. Eliminar un favorito por índice             (FavoritesController.RemoveFavorite)");
            Console.WriteLine("7. Mostrar lista de favoritos                  (FavoritesController.ShowFavorites)");
            Console.WriteLine("8. Borrar todos los favoritos                  (FavoritesController.ClearFavorites)");
            Console.WriteLine("0. Salir                                       (ExitMenu)");
            Console.WriteLine("====================================");
            PrintOptionMenu();
        }
