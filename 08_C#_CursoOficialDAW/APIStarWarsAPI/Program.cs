...
namespace APIStarWarsAPI
{
    internal class Program
    {
        ...
        // 2. BUSCAR por nombre
        // Metodo que llama a SearchByName para buscar el personaje
        public static async Task RequestSearchByName()
        {
            ...
            // *ajustar el formato a la api* de var item = result[0];
            JObject item = result; // item obtiene el personaje del metodo SearchByName()
