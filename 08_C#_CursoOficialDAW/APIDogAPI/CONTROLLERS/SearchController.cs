...
namespace APIDogAPI.CONTROLLERS
{
    internal static class SearchController
    {
        ...
        {
            Views.PrintAskBreed();
            string input = Helpers.ReadInput()?.Trim().ToLower();
            ...
            {
                int score = Helpers.LevenshteinDistance(input, breed.ToLower());
            ...
            Views.PrintApproximateMatches(ordered);
            Views.PrintWaitForPressKey();
        }
    }
}
