 ...
 * 4. (122) RemoveFavoriteList()                -> BORRAR de la lista de favoritos
 * 5. (144) ValidateInput(string input)         -> VALIDAR Input
 * 6. (157) PrintWaitForPressKey()              -> PRINT (esperar tecla)
 * 7. (166) HandlerException(Exception ex)     -> Manejo de EXCEPCIONES
 */

/*
 * Metodo de empleo
 * 1. (36) cambiar la url con el parametro que se quiere buscar (name)
 * 2. (84) cambiar los nombres de los atributos de la clase FavoriteItemList (atributes)
 */
