    ...
    internal class APIFavoriteList
    {
        ...
        {           
            ...
            try
            {
                ...
                var validation = ValidatedHttpResponse(response); 
                if (validation != "Response: OK")
                {
                    WaitForPressKey();
                    return;
                }
                var stringJson = await GetJson(response);
                var resultjson = DeserializedJson(stringJson);

                AddFavoriteList(num, resultjson);
        ...
        public static void AddFavoriteList(int id, NameClassContent objJson)
        {
            ...
            bool saved = Add(id, objJson);
            Console.WriteLine(saved ? "Guardado con exito" : "No se agrego a la Lista API");
        }
        ...
        {
            Console.WriteLine("¿Estas seguro que deseas borrar la Lista API? (S/N)");
            string input = Console.ReadLine();
            ...
            // Borrar lista
            FavoriteList.Clear();
            Console.WriteLine("Lista API borrada con éxito.");
