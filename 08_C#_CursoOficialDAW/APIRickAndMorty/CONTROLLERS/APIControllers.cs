...
namespace APIRickAndMorty
{
    internal class APIControllers
    {
        ...
        {
            // Peticion al servidor (Llamada a la API)
            ...
            ClassRoot json = DeserializedJsonRoot(stringJson);

            // Imprimir Json Deserializado
        ...
        public static ClassAtributes DeserializedJsonCharacter(string json) =>
            JsonConvert.DeserializeObject<ClassAtributes>(json);
