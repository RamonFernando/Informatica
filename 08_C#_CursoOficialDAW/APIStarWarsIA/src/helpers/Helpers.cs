...
namespace APIStarWarsIA
{
    public static class Helpers
    {
        ...
        public static int GetIntProp(JsonElement element, string propName)
        {
            ...
            {
                JsonValueKind.Number => prop.TryGetInt32(out var num) ? num : -1,
                JsonValueKind.String => int.TryParse(prop.GetString(), out var strNum) ? strNum : -1,
                _ => -1 // caso default
            };
        }
        ...
        // Array Strings
        // Obtiene todos los strings de un array en un JsonElement (string o "unknown" si no existe)
        public static string GetStringFromArray(JsonElement element, string propName)
        {
            if (!element.TryGetProperty(propName, out var prop) ||
        ...
        // Array List Strings
        // Obtiene todos los strings de un array en un JsonElement como una lista
        public static List<string> GetListFromArray(JsonElement element, string propName)
        {
