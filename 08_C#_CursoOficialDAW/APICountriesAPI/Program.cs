...
using static APICountriesAPI.APILoadJson;
using static APICountriesAPI.APISaveJson;
...
namespace APICountriesAPI
{
    internal class Program
    {
        ...
        public static string Url => "https://restcountries.com/v3.1/all?fields=name,flags"; // *cambiar url*

        public static List<FavoriteItemList> favoriteList = new List<FavoriteItemList>();

        public static string NameProperty => "Pais";
        public static string NameApi => "Countries API";
        ...
        public static async Task RequestSearchByName()
        {
            ...
            $"Nombre Oficial: {item["name"]["official"]}\n\n" +
            $"Informacion Extra: {item["name"]}\n");
